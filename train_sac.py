...
def main():
    ...
    try:
        model = SAC.load("models/kuka_iiwa_insertion-v0_sac_best_model",env, verbose=1, learning_starts=1000)
    except:
        ...
        if self.n_calls % self.check_freq == 0:
          ...
          if len(x) > 0:
              ...
              if mean_reward > self.best_mean_reward:
                  ...
                  self.model.save(os.path.join(self.save_path, 'kuka_iiwa_insertion-v0_sac_best_model'))
